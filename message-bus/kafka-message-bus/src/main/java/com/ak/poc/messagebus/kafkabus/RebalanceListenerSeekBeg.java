...
public class RebalanceListenerSeekBeg implements ConsumerRebalanceListener {

	private Map<TopicPartition, OffsetAndMetadata> currentOffsets = new HashMap<>();
	KafkaConsumer<String, String> consumer;

	public RebalanceListenerSeekBeg(Map<TopicPartition, OffsetAndMetadata> currentOffsets,
			KafkaConsumer<String, String> consumer) {
